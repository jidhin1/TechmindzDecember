...
public class HomePage extends Testbase {
	...
	public HomePage() { PageFactory.initElements(driver, this); 
		...
		pSignUpButton.click();
		} public void clickLoginButton() throws InterruptedException { Thread.sleep(2000);
		pLoginButton.click(); 
		}
		...
		public void clicksignupNameEnterText(String pValue) {
			...
			public void clicksignupButton()throws InterruptedException { 
				...
				Thread.sleep(2000); objWrapper.alert(driver); } 
			...
			publicvoid clickLoginCreateButton() throws InterruptedException { 
				pLogInCreate.click();
				Thread.sleep(2000); 
				objWrapper.alert(driver); } 
